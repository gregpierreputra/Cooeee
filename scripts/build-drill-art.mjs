...
// src/core/drill-atlas.ts (where each frame sits, which the house also reads to
// know how much floor each piece covers). Run: npm run build:drill:art
...
writeFileSync(
  new URL('../src/core/drill-atlas.ts', import.meta.url),
...
console.log('src/core/drill-atlas.ts', lines.length, 'sprites');
