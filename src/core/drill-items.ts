...
export const DRILL_ITEMS: DrillItem[] = [
  ...
  { id: 'television', name: 'television', room: 'living room', weight: -10, why: 'A television is heavy, slow to carry and replaceable.', x: 21.5, y: 2.62 },
  { id: 'console', name: 'games console', room: 'living room', weight: -10, why: 'A games console takes room in the car that water or a blanket needs.', x: 20.8, y: 3.65 },
  { id: 'painting', name: 'framed painting', room: 'living room', weight: -10, why: 'A large frame takes two hands and most of a boot.', x: 26.0, y: 2.375 },
  { id: 'boardgame', name: 'box of toy blocks', room: 'living room', weight: 0, why: 'Toys do no harm, and do not help you get out.', x: 21.5, y: 5.6 },
  { id: 'lamp', name: 'floor lamp', room: 'living room', weight: -10, why: 'A floor lamp fills the back seat and helps no one.', x: 23.5, y: 6.9 },
  // kitchen
  { id: 'water', name: 'drinking water', room: 'kitchen', weight: 10, why: 'The CFA says to take enough water. Heat and smoke dry you out fast.', x: 13.45, y: 3.35 },
  ...
  // laundry
  { id: 'blanket', name: 'wool blanket', room: 'laundry', weight: 10, why: 'The CFA says to keep wool blankets in the car. Wool shields you from radiant heat.', x: 7.6, y: 2.75 },
  ...
  { id: 'sanitiser', name: 'hand sanitiser', room: 'laundry', weight: 8, why: 'Hand sanitiser and wipes are on the CFA list for days away from home.', x: 9.6, y: 3.3 },
  // garage
