...
export const DRILL_ITEMS: DrillItem[] = [
  // living room
  { id: 'photos', name: 'family photos', room: 'living room', weight: 8, why: 'Photos cannot be replaced, and the CFA says to take them.', x: 25.6, y: 8.2 },
  ...
  { id: 'painting', name: 'framed painting', room: 'living room', weight: -10, why: 'A large frame takes two hands and most of a boot.', x: 25.7, y: 2.55 },
  { id: 'boardgame', name: 'box of toy blocks', room: 'living room', weight: 0, why: 'Toys do no harm, and do not help you get out.', x: 21.6, y: 5.1 },
  { id: 'lamp', name: 'floor lamp', room: 'living room', weight: -10, why: 'A floor lamp fills the back seat and helps no one.', x: 26.4, y: 4.3 },
  // kitchen
  { id: 'water', name: 'drinking water', room: 'kitchen', weight: 10, why: 'The CFA says to take enough water. Heat and smoke dry you out fast.', x: 13.3, y: 3.35 },
  { id: 'kettle', name: 'kettle', room: 'kitchen', weight: 0, why: 'A kettle changes nothing either way.', x: 14.5, y: 3.35 },
  ...
  // laundry
  { id: 'blanket', name: 'wool blanket', room: 'laundry', weight: 10, why: 'The CFA says to keep wool blankets in the car. Wool shields you from radiant heat.', x: 8.5, y: 2.75 },
  ...
  { id: 'sanitiser', name: 'hand sanitiser', room: 'laundry', weight: 8, why: 'Hand sanitiser and wipes are on the CFA list for days away from home.', x: 7.5, y: 2.7 },
  // garage
  ...
  { id: 'toolbox', name: 'toolbox', room: 'garage', weight: 0, why: 'A toolbox does nothing for the drive out.', x: 5.0, y: 4.9 },
  // main bedroom
  ...
  { id: 'pillow', name: 'pillow', room: 'main bedroom', weight: 0, why: 'A pillow is comfort, not readiness.', x: 2.6, y: 17.9 },
  ...
  // study
  { id: 'papers', name: 'passport and papers', room: 'study', weight: 10, why: 'Passports, wills and insurance papers are on the CFA list and are hard to replace.', x: 14.4, y: 17.4 },
  { id: 'laptop', name: 'computer', room: 'study', weight: 0, why: 'A computer is neither help nor harm.', x: 15.2, y: 17.4 },
  { id: 'memorystick', name: 'memory stick of scanned papers', room: 'study', weight: 8, why: 'The CFA says to scan papers and photos onto a memory stick.', x: 15.9, y: 17.5 },
